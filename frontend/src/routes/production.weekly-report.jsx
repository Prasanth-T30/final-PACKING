// production.weekly-report.jsx â€” Combined Weekly + Monthly Reports
...
export const Route = createFileRoute("/production/weekly-report")({
  head: () => ({ meta: [{ title: "Reports â€” BrushPack" }] }),
  component: Page,
});

/* â”€â”€ Weekly data (Monâ€“Sun) â”€â”€ */
const weeklyData = [
...
/* â”€â”€ Monthly data (Week 1â€“4 + full-month totals by type) â”€â”€ */
const monthlyData = [
...
function Page() {
  ...
  return (
    <DashboardLayout
      title="Reports"
      subtitle="Packing trends, line efficiency and dispatch summaries â€” weekly & monthly."
    >
      {/* Tab switcher */}
      <div
